   ...
   <section>
      ...
      <div class="pdf-container">
         ...
         <p>
            ...
            here to download
            <a :href="pdf">
               Constitution/GrondWet ({{ lang === 'ENG' ? 'AFR' : 'ENG' }}) </a
            >as a PDF
         </p>
      </div>
   </section>
...
export default {
   ...
   methods: {
      switchPdf() {
         var that = this;
         switch (this.pdf) {
            case '../pdf/Constitution.pdf':
               that.pdf = '../pdf/Grondwet.pdf';
               that.lang = 'ENG';
               break;
            case '../pdf/Grondwet.pdf':
               that.pdf = '../pdf/Constitution.pdf';
               that.lang = 'AFR';
               break;
         }
      },
